...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-danger fixed-top">
        <a href="index.php" class="navbar-brand">HETSO</a>
        <span class="navbar-text">Customer's Health is our Aim</span>
        <!-- Buttn hamburgur -->
    ...
    <header class="jumbotron back-img"
        ...
        <div class="introinner" style="display: block;margin-top: 142px;margin-left: 40px;">
            <h1 class="text-uppercase text-danger">Welcome to HETSO</h1>
            <p class="font-italic" style="color:white;">Customer's Heath is our aim</p>
    ...
    <div class="container" style="align-items: center; display: flex;margin-top: 50px;">
        <div class="ourservice" style="width: 80vw; align-items: center;background-color: rgb(192, 192, 181);">
            <h3 class="text-center" style="margin:10px;" id="about">WHY HETSO</h3>
...
?>
    ...
    ?>
            ...
            <div class="col-md-4 text-center">
                ...
                Phone: 8978643542 <br>
                <a href="#" target="_blank" style="color:#dc3545; text-decoration:none;">www.hetso.com</a><br><br><br>
    ...
    <footer class="container-fluid bg-dark mt-5">
        <div class="container">
            <div class="row py-3">
                ...
                <div class="col-md-6">
                    <small class="text-light">Designed by Team H2SO4 &copy; 2023</small>
                    <small class="ml-2"><a href="index.php" style="color:#dc3545; text-decoration:none;">
                            Visit Again</a></small>
                </div>
            </div>
        </div>
